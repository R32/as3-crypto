...
package net.hires.debug {
	...
	public class Stats extends Sprite {	
		...
		public function Stats() : void {
			...
			xml = <xml><fps>FPS:</fps><ms>MS:</ms><mem>MEM:</mem><memMax>MAX:</memMax><memdec>memdec:</memdec></xml>;
			...
			style.setStyle('memdec', {color: hex2css(0xffffff)});
		...
		private function update(e : Event) : void {
			...
			if( timer - 1000 > ms_prev ) {
				...
				if(mem)xml.memdec = "MemDec: "+ String((mem - memdec).toFixed(3));
				memdec = mem;	
